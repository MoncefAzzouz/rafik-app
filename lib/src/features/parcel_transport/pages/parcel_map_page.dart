...
class Wilaya {
  ...
  String get displayName =>
      '${number.toString().padLeft(2, '0')} - $nameAr ($nameEn)';
}

class ParcelMapPage extends StatefulWidget {
  final VehicleType selectedVehicle;

  const ParcelMapPage({super.key, required this.selectedVehicle});
...
class _ParcelMapPageState extends State<ParcelMapPage> {
  ...
  final List<Wilaya> _wilayas = const [
    Wilaya(
      ...
      nameAr: 'أدرار',
      nameEn: 'Adrar',
      coordinate: LatLng(27.87, -0.29),
    ),
    Wilaya(
      number: 2,
      nameAr: 'الشلف',
      nameEn: 'Chlef',
      coordinate: LatLng(36.16, 1.33),
    ),
    Wilaya(
      number: 3,
      nameAr: 'الأغواط',
      nameEn: 'Laghouat',
      coordinate: LatLng(33.80, 2.88),
    ),
    Wilaya(
      number: 4,
      nameAr: 'أم البواقي',
      nameEn: 'Oum El Bouaghi',
      coordinate: LatLng(35.87, 7.11),
    ),
    Wilaya(
      number: 5,
      nameAr: 'باتنة',
      nameEn: 'Batna',
      coordinate: LatLng(35.55, 6.17),
    ),
    Wilaya(
      number: 6,
      nameAr: 'بجاية',
      nameEn: 'Béjaïa',
      coordinate: LatLng(36.75, 5.08),
    ),
    Wilaya(
      number: 7,
      nameAr: 'بسكرة',
      nameEn: 'Biskra',
      coordinate: LatLng(34.85, 5.73),
    ),
    Wilaya(
      number: 8,
      nameAr: 'بشار',
      nameEn: 'Béchar',
      coordinate: LatLng(31.62, -2.22),
    ),
    Wilaya(
      number: 9,
      nameAr: 'البليدة',
      nameEn: 'Blida',
      coordinate: LatLng(36.47, 2.82),
    ),
    Wilaya(
      number: 10,
      nameAr: 'البويرة',
      nameEn: 'Bouira',
      coordinate: LatLng(36.37, 3.90),
    ),
    Wilaya(
      number: 11,
      nameAr: 'تمنراست',
      nameEn: 'Tamanrasset',
      coordinate: LatLng(22.78, 5.52),
    ),
    Wilaya(
      number: 12,
      nameAr: 'تبسة',
      nameEn: 'Tébessa',
      coordinate: LatLng(35.40, 8.12),
    ),
    Wilaya(
      number: 13,
      nameAr: 'تلمسان',
      nameEn: 'Tlemcen',
      coordinate: LatLng(34.88, -1.31),
    ),
    Wilaya(
      number: 14,
      nameAr: 'تيارت',
      nameEn: 'Tiaret',
      coordinate: LatLng(35.37, 1.32),
    ),
    Wilaya(
      number: 15,
      nameAr: 'تيزي وزو',
      nameEn: 'Tizi Ouzou',
      coordinate: LatLng(36.72, 4.05),
    ),
    Wilaya(
      number: 16,
      nameAr: 'الجزائر',
      nameEn: 'Alger',
      coordinate: LatLng(36.75, 3.06),
    ),
    Wilaya(
      number: 17,
      nameAr: 'الجلفة',
      nameEn: 'Djelfa',
      coordinate: LatLng(34.67, 3.25),
    ),
    Wilaya(
      number: 18,
      nameAr: 'جيجل',
      nameEn: 'Jijel',
      coordinate: LatLng(36.80, 5.77),
    ),
    Wilaya(
      number: 19,
      nameAr: 'سطيف',
      nameEn: 'Sétif',
      coordinate: LatLng(36.19, 5.41),
    ),
    Wilaya(
      number: 20,
      nameAr: 'سعيدة',
      nameEn: 'Saïda',
      coordinate: LatLng(34.83, 0.15),
    ),
    Wilaya(
      number: 21,
      nameAr: 'سكيكدة',
      nameEn: 'Skikda',
      coordinate: LatLng(36.88, 6.90),
    ),
    Wilaya(
      number: 22,
      nameAr: 'سيدي بلعباس',
      nameEn: 'Sidi Bel Abbès',
      coordinate: LatLng(35.20, -0.63),
    ),
    Wilaya(
      number: 23,
      nameAr: 'عنابة',
      nameEn: 'Annaba',
      coordinate: LatLng(36.90, 7.76),
    ),
    Wilaya(
      number: 24,
      nameAr: 'قالمة',
      nameEn: 'Guelma',
      coordinate: LatLng(36.46, 7.43),
    ),
    Wilaya(
      number: 25,
      nameAr: 'قسنطينة',
      nameEn: 'Constantine',
      coordinate: LatLng(36.36, 6.61),
    ),
    Wilaya(
      number: 26,
      nameAr: 'المدية',
      nameEn: 'Médéa',
      coordinate: LatLng(36.26, 2.75),
    ),
    Wilaya(
      number: 27,
      nameAr: 'مستغانم',
      nameEn: 'Mostaganem',
      coordinate: LatLng(35.93, 0.09),
    ),
    Wilaya(
      number: 28,
      nameAr: 'المسيلة',
      nameEn: 'M\'Sila',
      coordinate: LatLng(35.70, 4.54),
    ),
    Wilaya(
      number: 29,
      nameAr: 'معسكر',
      nameEn: 'Mascara',
      coordinate: LatLng(35.40, 0.14),
    ),
    Wilaya(
      number: 30,
      nameAr: 'ورقلة',
      nameEn: 'Ouargla',
      coordinate: LatLng(31.95, 5.32),
    ),
    Wilaya(
      number: 31,
      nameAr: 'وهران',
      nameEn: 'Oran',
      coordinate: LatLng(35.69, -0.63),
    ),
    Wilaya(
      number: 32,
      nameAr: 'البيض',
      nameEn: 'El Bayadh',
      coordinate: LatLng(33.68, 1.02),
    ),
    Wilaya(
      number: 33,
      nameAr: 'إليزي',
      nameEn: 'Illizi',
      coordinate: LatLng(26.48, 8.48),
    ),
    Wilaya(
      number: 34,
      nameAr: 'برج بوعريريج',
      nameEn: 'Bordj Bou Arréridj',
      coordinate: LatLng(36.07, 4.76),
    ),
    Wilaya(
      number: 35,
      nameAr: 'بومرداس',
      nameEn: 'Boumerdès',
      coordinate: LatLng(36.76, 3.47),
    ),
    Wilaya(
      number: 36,
      nameAr: 'الطارف',
      nameEn: 'El Tarf',
      coordinate: LatLng(36.76, 8.31),
    ),
    Wilaya(
      number: 37,
      nameAr: 'تندوف',
      nameEn: 'Tindouf',
      coordinate: LatLng(27.67, -8.13),
    ),
    Wilaya(
      number: 38,
      nameAr: 'تيسمسيلت',
      nameEn: 'Tissemsilt',
      coordinate: LatLng(35.60, 1.81),
    ),
    Wilaya(
      number: 39,
      nameAr: 'الوادي',
      nameEn: 'El Oued',
      coordinate: LatLng(33.36, 6.85),
    ),
    Wilaya(
      number: 40,
      nameAr: 'خنشلة',
      nameEn: 'Khenchela',
      coordinate: LatLng(35.43, 7.14),
    ),
    Wilaya(
      number: 41,
      nameAr: 'سوق أهراس',
      nameEn: 'Souk Ahras',
      coordinate: LatLng(36.28, 7.95),
    ),
    Wilaya(
      number: 42,
      nameAr: 'تيبازة',
      nameEn: 'Tipaza',
      coordinate: LatLng(36.59, 2.44),
    ),
    Wilaya(
      number: 43,
      nameAr: 'ميلة',
      nameEn: 'Mila',
      coordinate: LatLng(36.45, 6.26),
    ),
    Wilaya(
      number: 44,
      nameAr: 'عين الدفلى',
      nameEn: 'Aïn Defla',
      coordinate: LatLng(36.26, 2.02),
    ),
    Wilaya(
      number: 45,
      nameAr: 'النعامة',
      nameEn: 'Naâma',
      coordinate: LatLng(33.26, -0.31),
    ),
    Wilaya(
      number: 46,
      nameAr: 'عين تموشنت',
      nameEn: 'Aïn Témouchent',
      coordinate: LatLng(35.30, -1.14),
    ),
    Wilaya(
      number: 47,
      nameAr: 'غرداية',
      nameEn: 'Ghardaïa',
      coordinate: LatLng(32.48, 3.67),
    ),
    Wilaya(
      number: 48,
      nameAr: 'غليزان',
      nameEn: 'Relizane',
      coordinate: LatLng(35.74, 0.55),
    ),
    Wilaya(
      number: 49,
      nameAr: 'المغير',
      nameEn: 'El M\'Ghair',
      coordinate: LatLng(33.95, 5.92),
    ),
    Wilaya(
      number: 50,
      nameAr: 'المنيعة',
      nameEn: 'El Meniaa',
      coordinate: LatLng(30.58, 2.87),
    ),
    Wilaya(
      number: 51,
      nameAr: 'أولاد جلال',
      nameEn: 'Ouled Djellal',
      coordinate: LatLng(34.42, 5.06),
    ),
    Wilaya(
      number: 52,
      nameAr: 'برج باجي مختار',
      nameEn: 'Bordj Baji Mokhtar',
      coordinate: LatLng(21.33, 0.95),
    ),
    Wilaya(
      number: 53,
      nameAr: 'بني عباس',
      nameEn: 'Béni Abbès',
      coordinate: LatLng(30.08, -2.17),
    ),
    Wilaya(
      number: 54,
      nameAr: 'تيميمون',
      nameEn: 'Timimoun',
      coordinate: LatLng(29.25, 0.23),
    ),
    Wilaya(
      number: 55,
      nameAr: 'تقرت',
      nameEn: 'Touggourt',
      coordinate: LatLng(33.10, 6.06),
    ),
    Wilaya(
      number: 56,
      nameAr: 'جانت',
      nameEn: 'Djanet',
      coordinate: LatLng(24.55, 9.48),
    ),
    Wilaya(
      number: 57,
      nameAr: 'عين صالح',
      nameEn: 'In Salah',
      coordinate: LatLng(27.20, 2.47),
    ),
    Wilaya(
      number: 58,
      nameAr: 'عين قزام',
      nameEn: 'In Guezzam',
      coordinate: LatLng(19.57, 5.77),
    ),
  ];
                    ...
                    children: [
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      _pickupController.text.isNotEmpty
                                          ...
                                          : 'اختر ولاية الاستلام',
                                      style: TextStyle(
                                        color: _pickupController.text.isNotEmpty
                                            ? Colors.black
                                            : Colors.grey,
                                        fontSize: 14,
                                        fontWeight: FontWeight.bold,
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed:
                              (_pickupWilaya == null || _deliveryWilaya == null)
                              ? null
                              : () {
                                  Navigator.push(
                                    context,
